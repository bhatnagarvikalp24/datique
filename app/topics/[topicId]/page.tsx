  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white">
      ...
      <section className="border-b border-slate-800 px-6 py-12">
        <div className="mx-auto grid max-w-5xl gap-10 lg:grid-cols-[1fr_360px] lg:items-start">
          <div>
            <Link href="/#topics" className="text-sm text-slate-500 hover:text-white">
              ← Back to topics
            </Link>
            <p className="mt-8 text-xs font-semibold uppercase tracking-widest text-teal-400">
      ...
      <section className="px-6 py-14">
        <div className="mx-auto max-w-5xl">
          ...
          <h2 className="mt-3 text-3xl font-bold">What the assignments cover</h2>
          <p className="mt-3 max-w-2xl text-slate-400">
            Every subtopic includes multiple graded assignments with fully worked solutions.
          </p>
      ...
      <section className="border-y border-slate-800 bg-slate-900 px-6 py-14">
        <div className="mx-auto max-w-5xl">
          ...
          <h2 className="mt-3 text-3xl font-bold">What you unlock</h2>
      ...
      {/* FAQ */}
      <section className="border-t border-slate-800 bg-slate-900 px-6 py-14">
        <div className="mx-auto max-w-5xl">
